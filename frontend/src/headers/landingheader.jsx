...
function LandingHeader({ openaboutt, openlogin, opensign }) {
  ...
  return (
    <header id="landinghead" className="bg-[#434343] h-[50%] w-[150%] absolute bottom-[-10%] right-[-86%] rotate-[120deg] flex justify-center items-center z-5 lg:right-[-70%] lg:h-[60%] lg:rotate-[130deg]">
