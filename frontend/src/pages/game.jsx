      ...
      <div className=" w-[100%] h-[70%] flex flex-col justify-center items-center">
        <div className="w-[80%] h-[40%] border-[1px] rounded-sm max-w-[500px] flex justify-center text-center items-center">
          <p className="w-[80%]">
            ...
            tenetur eos suscipit, repudiandae modi fuga perferendis dolore sequi
            beatae mollitia autem nesciunt ad, ipsam ullam iure aut laborum
            incidunt unde!
          </p>
        </div>
        ...
        <div className="w-[80%] h-[50%] flex flex-col items-center justify-center gap-[5%]">
          ...
          <div
            className="pickb choice w-[100%] h-[15%]  max-w-[500px] bg-[white]  text-[#ff6583] px-5 py-2 text-sm shadow-sm hover:shadow-lg  active:shadow-lg  flex justify-center items-center font-medium tracking-wider border-2 border-[#ff6583] active:bg-[#ff6583] active:border-[#ff6583] active:text-white hover:bg-[#ff6583] hover:border-[#ff6583] hover:text-white  rounded-sm transition ease-in duration-150"
            onClick={() => selected("pickb")}
          >
            <p className="w-[90%]">
              A. Lorem ipsum dolor sit amet consectetur adipisicing elit.
            </p>
          ...
          <div
            className="pickc choice w-[100%] h-[15%]  max-w-[500px] bg-[white] text-[#ff6583] px-5 py-2 text-sm shadow-sm hover:shadow-lg  active:shadow-lg  flex justify-center items-center font-medium tracking-wider border-2 border-[#ff6583] hover:bg-[#ff6583] active:bg-[#ff6583] active:border-[#ff6583] active:text-white hover:border-[#ff6583] hover:text-white  rounded-sm transition ease-in duration-150"
            onClick={() => selected("pickc")}
          >
            <p className="w-[90%]">
              A. Lorem ipsum dolor sit amet consectetur adipisicing elit.
            </p>
          ...
          <div
            className="pickd choice w-[100%] h-[15%]  max-w-[500px] bg-[white] text-[#ff6583] px-5 py-2 text-sm shadow-sm hover:shadow-lg  active:shadow-lg  flex justify-center items-center font-medium tracking-wider border-2 border-[#ff6583] hover:bg-[#ff6583] active:bg-[#ff6583] active:border-[#ff6583] active:text-white hover:border-[#ff6583] hover:text-white  rounded-sm transition ease-in duration-150"
            onClick={() => selected("pickd")}
          >
            <p className="w-[90%]">
              A. Lorem ipsum dolor sit amet consectetur adipisicing elit.
            </p>
